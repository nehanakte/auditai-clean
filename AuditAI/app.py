...
user_input = st.text_area("🧠 Describe your AI system:", height=200, placeholder="E.g. An AI system used to screen resumes for government jobs...")
...
if st.button("🔍 Run Audit"):
    if user_input.strip() == "":
        ...
        with st.spinner("Auditing in progress..."):
            ...
            # Split based on headings if you used clear sections in the LLM response
            try:
